...
pub fn Footer() -> Html {
    ...
    html! {
        <footer class="footer">
            ...
            // <a href="https://github.com/mathkimchi/mathkimchi.github.io" style="color: var(--text); text-decoration: none; font-weight: bold;"> {"Made with Yew by Alvin Kim"} </a>
            <a href="https://github.com/mathkimchi/mathkimchi.github.io" style="color: var(--text);"> {"Made with Yew by Alvin Kim"} </a>
